            ...
            <article className="event-detail-card" onClick={event => event.stopPropagation()}>
              ...
              <div className="event-detail-body">
                ...
                <div className="event-detail-actions">
                  <button type="button" className="event-detail-secondary event-detail-arrow-back" aria-label="Quay lại" onClick={handleBack}>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
                      <path d="m15 6-6 6 6 6" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </button>
                  <Link to="/auth" className="event-detail-primary">Đăng nhập để mua vé</Link>
                </div>
              </div>
            </article>
          </div>
